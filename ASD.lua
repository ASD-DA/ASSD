...
io.popen("cd library && wget https://raw.githubusercontent.com/zzT4T/ASD/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/zzT4T/Files_ASD/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevASDW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevASDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(147982809) then  
var = true  
...
local UserName = (data.username_ or "zzT4T")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@vvvv_23")  
...
--------------------------------------------------------------------------------------------------------------
function SourceASD(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ASD1:List:Filter"..sl)
...
if not DevASDW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevASDW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ASD_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevASDW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevASDW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevASDW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevASDW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevASDW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevASDW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevASDW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevASDW(msg) then 
os.execute('rm -rf ASD.lua')
os.execute('wget https://raw.githubusercontent.com/zzT4T/ASD/main/ASD.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس اسد*\n*⌯︙الاصدار » { 2.8v}*')
dofile('ASD.lua')  
end
if text == 'الاصدار ⌯' and DevASDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس اسد* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevASDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/zzT4T) \n⌯︙[قناه السورس](t.me/zzT4T)')
end
if text == "ضع اسم للبوت ⌯" and DevASDW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevASDW(msg) then 
...
if text == 'المشتركين ⌯' and DevASDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevASDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevASDW(msg) then
...
if text == ("قائمه العام ⌯") and DevASDW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevASDW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevASDW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevASDW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevASDW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevASDW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevASDW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevASDW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevASDW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevASDW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..ASDk..''..ASD..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevASDW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'zzT4T')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevASDW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zzT4T')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevASDW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevASDW(msg) then
...
local ASD1_Msg = database:get(bot_id.."ASD1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ASD1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zzT4T')..') \n ⌯︙'..ASD1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ASD_Msg and not Special(msg) then  
local ASD_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ASD_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..ASD_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/zzT4T)}\n⌯︙["..ASD_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا ↫* {["..data.first_name_.."](T.ME/zzT4T)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevASDW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevASDW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevASDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevASDW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevASDW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevASDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevASDW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevASDW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevASDW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."ASD:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ASD:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ASD = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ASD then 
names_ASD = database:smembers(bot_id.."ASD:blocname"..msg.chat_id_) or ""
if names_ASD and names_ASD[1] then 
for i=1,#names_ASD do 
if name_ASD:match("(.*)("..names_ASD[i]..")(.*)") then 
...
database:set(bot_id.."ASD:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ASD:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ASD:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ASD:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ASD:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ASDa_new(ASD1,ASD2)
if ASD2 and ASD2.first_name_ then 
if ASD2.first_name_:match("(.*)"..database:get(bot_id.."ASD:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ASD:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ASD_nnn = database:get(bot_id.."ASD:nump"..msg.chat_id_) or 5
local ASD_nnn2 = database:get(bot_id.."ASD:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ASD_nnn2) == tonumber(ASD_nnn) or tonumber(ASD_nnn2) > tonumber(ASD_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ASD:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..ASD2.username_.."](https://t.me/"..(ASD2.username_ or "zzT4T")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ASD:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(ASD_nnn) - tonumber(ASD_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ASDa_new)
end
end
...
local ASDChengName = database:get(bot_id.."ASD:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ASDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ASDChengName..']')
database:del(bot_id.."ASD:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ASDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ASD:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ASDChengUserName = database:get(bot_id.."ASD:Cheng:UserName"..data.id_)
if not data.username_ then 
if ASDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ASDChengUserName..']')
database:del(bot_id.."ASD:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ASDChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ASD:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ASDChengPhoto = database:get(bot_id.."ASD:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ASDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ASD:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ASDChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ASD:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [- AsD TeAm .](t.me/zzT4T)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- قناه السوࢪس .',url="https://t.me/zzT4T"},
},
{
{text = '- شروحات السوࢪس .',url="https://t.me/zzT4T"},
},
{
{text = '- تواصل السوࢪس .',url="t.me/vvvv_23"},
},
{
{text = '- مطوࢪ السوࢪس .',url="t.me/vvvv_23"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'رفع نسخه الاحتياطيه' and DevASDW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌯︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zzT4T')..') \n*⌯︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'zzT4T')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevASDW(msg) then
dofile('ASD.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevASDW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevASDW(msg) then  
function start_function(extra, result, success)
if ASDSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevASDW(msg) then  
...
if text and text:match("^حظر عام (%d+)$") and DevASDW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if ASDSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevASDW(msg) then  
function start_function(extra, result, success)
if ASDSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevASDW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevASDW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if ASDSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevASDW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevASDW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevASDW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevASDW(msg) then
...
if text == 'الملفات' and DevASDW(msg) then
t = ' *⌯︙ملفات السورس اسد ↓*\n*•━━━━━━ ASD ━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevASDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/zzT4T/Files_ASD/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات اسد*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ ASD ━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ ASD ━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس اسد ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/zzT4T) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevASDW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/zzT4T/Files_ASD/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ASD.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس اسد* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevASDW(msg) then
...
if text == "مسح الملفات" and DevASDW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevASDW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevASDW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "zzT4T")
...
function Function_ASD(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ASD, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ASD, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'zzT4T')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zzT4T')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zzT4T')..')'
...
database:set(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ASD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ASD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ASD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ASD1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ASD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ASD1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ASD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ASD1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ASD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ASD1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ASD1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevASDW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevASDW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'zzT4T')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevASDW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevASDW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اسد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اسد')
local ASD_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..ASD_Msg[math.random(#ASD_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevASDW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,ASD)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ASD ━━━━━━•*\n"
x = 0
local list = ASD.members_
for k, v in pairs(list) do
x = x + 1
...
if ASDSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevASDW(msg) then 
...
if text == ("ردود المطور") and DevASDW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ ASD ━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevASDW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevASDW(msg) then    
...
if text == 'تفعيل المغادره' and DevASDW(msg) then   
...
if text == 'تعطيل المغادره' and DevASDW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'zzT4T')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ASDdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevASDW(msg) then
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/zzT4T"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/zzT4T"}},
{{text = 'مطور السورس', url="t.me/vvvv_23"}},
}
...
zh = https.request('https://vvvzvv.ml/amirZhfa/ASD.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ ASD ━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ ASD ━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀](t.me/zzT4T) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/ASD.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/ASD.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/ASD.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴀsᴅ',url='http://t.me/zzT4T'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اسد')
...
ASD = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ASD)
...
------------------------------------------------------------------------
local ASDAbot = database:get(bot_id.."ASD1:Add:Filter:Rp2"..text..result.chat_id_)   
if ASDAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..ASDAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ASD1_Msg = database:get(bot_id.."ASD1:Add:Filter:Rp2"..text..result.chat_id_)   
if ASD1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..ASD1_Msg)
